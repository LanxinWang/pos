...
jest.mock("../src/items", () => ({
  loadAllItems: jest.fn().mockReturnValue(_mockLoadAllItems),
}));
// beforeEach(() => {
//   jest.spy;
//   jest.mock("../src/items", () => ({
//     loadAllItems: jest.fn().mockReturnValue(mockLoadAllItems),
//   }));
//   jest.mock("../src/promotions", () => ({
//     loadPromotions: jest.fn().mockReturnValue(mockLoadPromotions),
//   }));
// });
...
describe("pos when input tags with no BUY_TWO_FREE_ONE promotions", () => {
  it("should print correct receipt when input 1 non-weigh-in tag", () => {
    ...
    **********************`;
    ...
    const result = printReceipt(inputTags, mockLoadPromotions);
