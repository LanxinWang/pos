...
describe("pos when input tags with no BUY_TWO_FREE_ONE promotions", () => {
  ...
  //different same kind item tags weighting-count can not be added
  it("should print correct receipt when input 1 1-pounds weigh-in and 1 2-pounds same kind tags", () => {
    const inputTags = ["ITEM000001-1", "ITEM000001-1", "ITEM000001-1"];
    const expectReceipt = `
    ***<没钱赚商店>收据***
    名称：苹果，数量：1斤，单价：5.50(元)，小计：5.50(元)
    名称：苹果，数量：1斤，单价：5.50(元)，小计：5.50(元)
  ...
  it("should print correct receipt when input 1 1-pounds weigh-in and 1 3-pounds same kind tags", () => {
    const inputTags = ["ITEM000001-1", "ITEM000001-3"];
    const expectReceipt = `
    ***<没钱赚商店>收据***
    名称：苹果，数量：1斤，单价：5.50(元)，小计：5.50(元)
    名称：苹果，数量：3斤，单价：5.50(元)，小计：16.50(元)
...
describe("pos when input tags with BUY_TWO_FREE_ONE promotions", () => {
  ...
  //different same kind item tags weighting-count can not be added
  it("should print correct receipt when input 3 1-pounds weigh-in same kind item tags", () => {
    const inputTags = ["ITEM000003-1", "ITEM000003-1", "ITEM000003-1"];
    const expectReceipt = `
    ***<没钱赚商店>收据***
    名称：荔枝，数量：1斤，单价：15.00(元)，小计：15.00(元)
    名称：荔枝，数量：1斤，单价：15.00(元)，小计：15.00(元)
  ...
  it("should print correct receipt when input 1 1-pounds and 1 3-pounds weigh-in same kind item tags", () => {
